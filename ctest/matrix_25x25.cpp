...
int test_matrix_4x4() {
  ...
  std::vector<std::vector<int>> expected = {
      {23, 18, 20, 8, 15, 22, 21, 6, 17, 3, 13, 9, 5, 11, 10, 24, 19, 14, 7, 4, 12, 25, 16, 1, 2},
      {12, 21, 14, 3, 11, 24, 16, 2, 4, 13, 7, 25, 8, 17, 23, 1, 15, 20, 18, 22, 6, 19, 9, 10, 5},
      {19, 16, 25, 4, 7, 14, 10, 9, 5, 18, 15, 2, 1, 12, 20, 8, 17, 3, 6, 13, 23, 11, 21, 22, 24},
      {22, 24, 17, 6, 2, 23, 1, 20, 12, 11, 14, 18, 21, 19, 4, 10, 5, 16, 9, 25, 13, 8, 7, 15, 3},
      {10, 1, 9, 5, 13, 25, 8, 15, 19, 7, 24, 16, 3, 22, 6, 2, 21, 11, 12, 23, 14, 18, 4, 17, 20},
      {6, 3, 2, 11, 10, 15, 25, 1, 14, 16, 23, 5, 4, 21, 9, 22, 24, 18, 8, 20, 19, 12, 13, 7, 17},
      {20, 25, 8, 1, 18, 19, 24, 13, 9, 21, 12, 7, 15, 6, 22, 23, 14, 4, 2, 17, 16, 5, 3, 11, 10},
      {16, 13, 23, 12, 22, 6, 20, 3, 18, 4, 17, 14, 19, 10, 25, 7, 11, 1, 15, 5, 9, 21, 2, 24, 8},
      {21, 17, 5, 14, 19, 12, 7, 23, 22, 2, 11, 8, 13, 20, 24, 3, 10, 9, 25, 16, 15, 6, 1, 4, 18},
      {9, 4, 7, 15, 24, 8, 5, 11, 10, 17, 3, 1, 2, 18, 16, 21, 12, 6, 13, 19, 20, 22, 14, 23, 25},
      {18, 22, 15, 19, 16, 4, 13, 14, 23, 9, 2, 10, 17, 5, 11, 20, 3, 8, 21, 1, 24, 7, 12, 25, 6},
      {3, 23, 21, 2, 5, 20, 6, 17, 15, 1, 19, 4, 12, 16, 14, 25, 22, 10, 24, 7, 18, 9, 11, 8, 13},
      {4, 14, 6, 20, 1, 11, 2, 18, 25, 5, 9, 22, 24, 7, 8, 17, 13, 12, 23, 15, 10, 16, 19, 3, 21},
      {8, 9, 13, 25, 12, 7, 19, 21, 24, 10, 1, 20, 18, 23, 3, 16, 6, 2, 14, 11, 22, 4, 17, 5, 15},
      {24, 7, 11, 10, 17, 16, 12, 22, 3, 8, 6, 21, 25, 15, 13, 4, 18, 19, 5, 9, 1, 20, 23, 2, 14},
      {13, 2, 19, 16, 20, 5, 23, 7, 8, 22, 10, 17, 14, 4, 12, 15, 9, 25, 3, 24, 21, 1, 18, 6, 11},
      ...
      {15, 10, 22, 9, 6, 3, 14, 4, 20, 24, 16, 13, 23, 25, 17, 12, 1, 21, 11, 18, 5, 2, 8, 19, 7},
      {5, 19, 4, 18, 3, 17, 9, 16, 11, 23, 22, 12, 10, 2, 15, 13, 7, 24, 20, 8, 25, 14, 6, 21, 1},
      {14, 20, 16, 24, 23, 1, 18, 5, 21, 19, 8, 11, 6, 3, 7, 9, 25, 22, 17, 2, 4, 10, 15, 13, 12}
  };

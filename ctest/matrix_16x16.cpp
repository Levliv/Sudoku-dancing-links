...
int test_matrix_16x16() {
  int err_code = 0;
  int size = 16;
  auto* sudokuDLXSolver = new SudokuDLXSolver(size);
  std::vector<std::vector<int>> input = {{0, 15, 0, 1, 0, 2, 10, 14, 12, 0, 0, 0, 0, 0, 0, 0},
  ...
  std::vector<std::vector<int>> expected = {{8, 15, 11, 1, 6, 2, 10, 14, 12, 7, 13, 3, 16, 9, 4, 5},
